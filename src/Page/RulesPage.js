...
<h1>ПРАВИЛА ПОДАЧИ ЗАЯВЛЕНИЯ НА РАЗБАН</h1>
<div className="rules-content">
    <div className="rule">
    ...
    <div className="rule">
        ...
        <ul>
            <li>Ваш никнейм.</li>
            <li>Ссылка на репорт, в котором указан бан.</li>
            <li>Причины, по которым вас должны разбанить (опишите ваше понимание ситуации и причины для разбана).</li>
            <li>Вклад, который вы вносите в сервер (чем вы помогаете сообществу, ваши достижения).</li>
        </ul>
    </div>
    <div className="rule">
        <strong>1.3</strong> Заявка должна быть написана честно и подробно, чтобы ускорить процесс её рассмотрения.
    </div>
    <div className="rule">
        <strong>1.4</strong> Священник оставляет за собой право запросить дополнительные доказательства или информацию перед принятием решения.
    </div>
</div>
