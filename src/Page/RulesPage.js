        ...
        <div className="back_img">
            ...
            <div className="rules-page ">
                ...
                <div className="rules-content">
                    ...
                    <div className="rule">
                        <strong>3.6</strong> Вся территория или её часть может быть полностью закрыта, если владелец так
                        решит.
                        ...
                        этой территории. Жители
                        обязаны вернуть игроку все его вещи.
                    </div>
                    <div className="rule">
                    ...
                    <div className="rule">
                        <strong>3.8</strong> Владелец территории не может налагать штрафы или уничтожать постройки
                        игроков, проживающих на
                        его территории, без их согласия.
                        <h4>Исключение:</h4>Владелец территории может управлять земельным участком, если он был
                        признан бесхозным и
                        подтверждено Администрацией.
                    </div>
                    <div className="rule">
                        <strong>3.9</strong> Если игрок не посещает игру более 21 дня, его территория может быть
                ...
                <div className="rules-content">
                    ...
                    <div className="rule">
                        <strong>4.8</strong> Репорт на кражу в бизнесе можно подать только по факту нарушения. Возврат
                        за украденные
