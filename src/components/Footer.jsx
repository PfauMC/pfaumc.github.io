    ...
    <footer className="relative bg-bg-section border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="py-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Socials */}
          <div>
            <h4 className="font-semibold text-white text-sm mb-4">Сообщество</h4>
            <ul className="space-y-2.5">
              <li>
                <a
        ...
        <div className="py-5 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            <a href="https://t.me/pfaumc" target="_blank" rel="noopener noreferrer" className="text-text-light/40 hover:text-accent transition-colors" aria-label="Telegram">
              <TelegramIcon className="w-4 h-4" />
            </a>
            <a href="https://discord.gg/BPmxWwdChY" target="_blank" rel="noopener noreferrer" className="text-text-light/40 hover:text-accent transition-colors" aria-label="Discord">
              <DiscordIcon className="w-4 h-4" />
            </a>
          </div>
        </div>
