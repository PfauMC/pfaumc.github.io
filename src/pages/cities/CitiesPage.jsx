    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-xs text-text-light/50 leading-relaxed">
          Перед отправкой сервер проверит: больше 7 дней игрового времени, что вы ещё не глава другого города,
          расстояние от спавна (от 1000 блоков) и до ближайшего города (от 300 блоков). Наличие построек
