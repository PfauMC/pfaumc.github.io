...
const faqData = [
  ...
  },
  {
    ...
    items: [
      {
        q: 'Чем отличаются режимы Ванила и ГойЛенд?',
        a: 'Ванила — это классический SMP без PvP, где ценятся постройки, сотрудничество и честная игра. ГойЛенд — анархия и PvP-режим с возможностью грифа и захвата территорий. Подробнее на главной странице в разделе «Режимы».',
      },
      {
