...
export const mechanicsSections = [
  {
    ...
    items: [
      ...
      'Доступные команды: /msg (алиасы /m, /tell, /w, /whisper, /pm, /dm, /message) — личное сообщение, /reply (/r) — ответ последнему написавшему, /rules — ссылка на правила, /skin <ник> — сменить скин, /co i — инспектор CoreProtect (подробнее — в разделе «Логирование действий»).',
    ],
  },
  {
  ...
  },
  {
    ...
    scope: 'all',
    items: [
      'Сложность hard, радиус симуляции 8, спаунрейт обычный. Обычные ванильные автоматические и полуавтоматические фермы разрешены, если не используют запрещённые эксплойты и не создают чрезмерную нагрузку на сервер.',
  ...
  },
  {
    ...
    items: [
      ...
      'Территории и строительство на спавне регулирует Министр финансов — строить можно только с его разрешения. Билдер помогает со строительством и соответствием стилистике.',
      'Участки под магазины на спавне выдаются по мере освобождения свободных территорий.',
  ...
  },
  {
    ...
    items: [
      ...
      'Обычным игрокам доступен инспектор CoreProtect. Команда /co i включает режим проверки истории блока или контейнера: можно посмотреть, кто и когда взаимодействовал с ним.',
      'Повторная команда /co i выключает инспектор.',
...
export function MechanicsSection({ id, category, icon, items, important, scope }) {
