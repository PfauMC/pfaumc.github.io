...
export const mechanicsSections = [
  ...
  },
  {
    ...
    items: [
      ...
      'Если ограничение не пропало по истечении срока — обратитесь в Discord.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      'Строить на спавне можно только по согласованию с администрацией или билдерами проекта.',
